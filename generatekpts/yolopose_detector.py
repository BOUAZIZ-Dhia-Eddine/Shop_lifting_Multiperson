...
class PoseCompiler:
    def __init__(self, path_video, model_path="yolov8m-pose.pt", SlidingFrame=30, seuille_supp=14,max_personne=3):
    ...
    (14, 16) ,(4, 6), (3, 5), (15, 11), (16, 12), (12, 8), (11, 7),(0,6),(0,5) # Genou droit -> Cheville droite
]
    ...
    def interpolate_keypoints(self, keypoints):
        """Corrige les keypoints invalides en utilisant la moyenne des voisins valides."""
    ...
    def Track_Image(self, image_array, n_h, n_w):
        results = self.model.track(
            ...
            show=False,
            save=False,
            tracker='/home/birali/Downloads/generatekpts/generatekpts/utils/botsortMediaPipe.yaml',
            persist=True,
            device='cpu'
        )
    ...
    def VideoLecture(self, target_width=640, target_height=360):
            ...
            #output_video_path = "C:/Users/PC_DHIA/Desktop/videos_pose_estimation/290voir2.mp4"
            ...
            for comp_frame in range(total_nb_frame):
                ...
                dict_results, image_array= self.Track_Image(frame, n_h, n_w)
...
if __name__ == "__main__":
    video_source = "C:/Users/PC_DHIA/Desktop/videos_pose_estimation/0934.mp4"
